...
Name: openssh
Version: 5.3p1
Release: 53.moonshot1%{?dist}.5%{?rescue_rel}
...
# GSS-API related fixes
Patch101: openssh-gssapi-generic.patch
Patch102: openssh-nulluser.patch
...
%patch101 -p1 -b .gssapi-generic
%patch102 -p1 -b .nulluser
